...
# - Gruppo 1 (primo outlier): 2 features anomale, valore = mean ± factor*std
# - Gruppo 2 (i successivi 2 outliers): 4 features anomale, valore = mean ± factor*std
# - Gruppo 3 (ultimo outlier): 1 feature anomala, valore = mean ± factor*std
